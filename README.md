...
Full pricing detail (methodology, formula, dynamic-pricing audit trail): [tldrapi.com/pricing](https://tldrapi.com/pricing). Live rates via `/rates` or the SDK's `rates()` method.Rates(ctx)`.
